...
<html>
	...
	function delperson(missionId,userId)
				{
						document.form1.action="${pageContext.request.contextPath}/mission/personal!delPersonalForLeader.do?missionId="+missionId+"&uuids="+userId;
	...
	<body>
		...
		<div align="center">
			...
			action="personal!listPersonalForLeader" namespace="/mission"
		...
		<s:form id="form1" name="form1"
				method="post">
				<display:table id="dtable" name="pageView" style="width:700px;"
					sort="external" pagesize="${pageSize}" cellspacing="1"
					class="list_tb"
					requestURI="${pageContext.request.contextPath}/mission/personal!listPersonalForLeader.do">
					...
					<display:column title="操作">
						<a href="${pageContext.request.contextPath}/mission/personal!delPersonalForLeader.do?missionId=${dtable.mission.missionId }&uuids=${dtable.usersByUserid.userId}" onclick="return del()">删除</a>
					</display:column>
				</display:table>&nbsp;&nbsp;&nbsp;&nbsp;
			</s:form>
		</center>
