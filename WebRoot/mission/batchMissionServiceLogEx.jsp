...
function check(selectId){
	...
	var url;
	if(id==1){
		url='${pageContext.request.contextPath}/teamTree!showTeamTreeRootEx.action?missionId=${missionId}';
	}else{
		url='${pageContext.request.contextPath}/teamTree!showTeamByIdEx.action?missionId=${missionId}'
	}
	...
	<body>
		...
		<tr>
			...
			<tr>
				<td>
					<iframe name="teamTree" id="teamTree" src ='${pageContext.request.contextPath}/teamTree!showTeamTreeRootEx.action?missionId=${missionId}' width="300px" height="700" scrolling="Auto" frameborder="2"></iframe>				
				</td>
			</tr>
		</table>
		</center>
