...
<html>
  ...
  <br/>  <center>
		<div align="center">
			...
			action="list!listMissionForServiceLogByPersonal" namespace="/mission"
			method="post">
				<table>
				<tr>
					<td>项目类型:&nbsp;</td>
  ...
  <display:table id="idListTb" name="missions"  style="width:750px;" sort="external" pagesize="${pageSize}" cellspacing="1"  class="list_tb" requestURI="${pageContext.request.contextPath}/mission/list!listMissionForServiceLogByPersonal.do">
			...
			<display:column title="岗位">
				<a href="${pageContext.request.contextPath}/missionservicelog/list!showPersonal.do?missionId=${idListTb.missionId}">考勤</a>
            </display:column>
		</display:table>
	    </center>
	<br/>	
