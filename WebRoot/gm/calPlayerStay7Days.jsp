...
<html>
	...
	<body>
		...
		<br />
							...
							action="list!calPlayerStay7Days.do" namespace="/gmmanage"
							method="post">
							<center>
								<table >
									<tr >
									    <td>请选择日期:&nbsp;</td>
										<td colspan="2">&nbsp;<input id="d52211" name="startDate" class="Wdate" type="text" onFocus="var d52222=$dp.$('d52222');WdatePicker({onpicked:function(){d52222.focus();}, minDate:'%y-{%M-3}-%d' ,maxDate:'#F{$dp.$D(\'d52222\')||\'%y-%M-{%d-7}\'}'})"/>
												至
		...
		<display:table id="idListTb" name="pageView" style="width:650px;"
			...
			requestURI="${pageContext.request.contextPath}/gmmanage/list!calPlayerStay7Days.do">
			<display:caption>7天留存率</display:caption>
