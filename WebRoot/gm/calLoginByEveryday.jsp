...
<html>
	...
	<body>
		...
		<br />
							...
							action="list!calLoginByEveryday.do" namespace="/gmmanage"
							method="post">
							<center>
								<table >
									<tr >
		...
		<display:table id="idListTb" name="pageView" style="width:650px;"
			...
			requestURI="${pageContext.request.contextPath}/gmmanage/list!calLoginByEveryday.do">
			<display:caption>每天登陆数</display:caption>
			<display:column property="countDate" title="日期" />
			<display:column property="number" title="数量" />
