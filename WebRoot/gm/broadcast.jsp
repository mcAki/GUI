...
#newsletter_topics label.error {
	...
	<body>
		<center>
			...
			<s:form id="strutsForm" action="doBroadcast" namespace="/gmmanage"
				method="post">
				<s:token></s:token>
				...
				<table width="600" border="0" class="form_tb">
					...
					<tr>
						...
						<td>
							<s:textarea name="broadcastVo.content" id="broadcastVo.content" cssClass="txtW5" rows="4"/>
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td align="left">
							<s:textfield name="broadcastVo.times" id="broadcastVo.times" />
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td align="left">
							<s:textfield name="broadcastVo.interval" id="broadcastVo.interval" />秒
						</td>
					</tr>
					<tr>
						<td align="right">
						...
						<td align="left">
							<s:select cssClass="txtW2" name="broadcastVo.type" list="%{#{1:'屏幕上方',2:'聊天栏',3:'所有'}}"/>
						</td>
					</tr>
					...
					<tr><td colspan="2">&nbsp;</td></tr>
					<tr>
				  	    <td colspan="2" align="center" valign="middle"><s:submit icon="icon-apply" value="提交"></s:submit>
				        </td>
			        </tr>
				</table>
			</s:form>
