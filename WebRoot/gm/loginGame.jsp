...
#newsletter_topics label.error {
	...
	<body>
		<center>
			...
			<s:form id="strutsForm" action="doLoginGame" namespace="/gmmanage"
				...
				<table width="600" border="0" class="form_tb">
					...
					<tr>
						...
						<td>
							<s:textfield name="openid" id="openid"/>
						</td>
					</tr>
					<tr>
				  	    <td colspan="2" align="center" valign="middle"><s:submit icon="icon-apply" value="登陆"></s:submit>
				        </td>
			        </tr>
				</table>
			</s:form>
