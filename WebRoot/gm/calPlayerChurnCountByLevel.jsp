...
<html>
	...
	<body>
		...
		<br />
							...
							action="list!calPlayerChurnCountByLevel.do" namespace="/gmmanage"
							method="post">
							<center>
								<table >
									<tr >
		...
		<display:table id="idListTb" name="pageView" style="width:650px;"
			...
			requestURI="${pageContext.request.contextPath}/gmmanage/list!calPlayerChurnCountByLevel.do">
			<display:caption>等级分布流失人数</display:caption>
