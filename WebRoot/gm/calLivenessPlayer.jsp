...
<html>
	...
	<body>
		...
		<br />
							...
							action="list!calLivenessPlayer.do" namespace="/gmmanage"
							method="post">
							<center>
								<table >
									<tr >
		...
		<display:table id="idListTb" name="pageView" style="width:650px;"
			...
			requestURI="${pageContext.request.contextPath}/gmmanage/list!calLivenessPlayer.do">
			<display:caption>活跃用户统计</display:caption>
