...
<html>
	...
	<body>
		...
		<br />
							...
							action="list!calPlayerChurnRate.do" namespace="/gmmanage"
							method="post">
							<center>
								<table >
									<tr >
		...
		<display:table id="idListTb" name="pageView" style="width:650px;"
			...
			requestURI="${pageContext.request.contextPath}/gmmanage/list!calPlayerChurnRate.do">
			<display:caption>玩家流失率</display:caption>
			<display:column property="countDate" title="日期" />
			<display:column property="count" title="流失人数" />
			<display:column property="countAll" title="注册人数" />
			<display:column title="流失率" >
