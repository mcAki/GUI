...
#newsletter_topics label.error {
	...
	<body>
		<center>
			...
			<s:form id="strutsForm" action="doShutdown" namespace="/gmmanage"
				method="post">
				<s:token></s:token>
				...
				<table width="600" border="0" class="form_tb">
					...
					<tr>
						...
						<td>
							<s:select cssClass="txtW2" name="serverId" id="server" list="servers" listKey="id" listValue="servername" />
						</td>
					</tr>
					<tr>
				  	    <td colspan="2" align="center"><s:submit icon="icon-apply" value="提交" onclick="return window.confirm('您确定要关闭吗？')"></s:submit>
				        </td>
			        </tr>
				</table>
			</s:form>
