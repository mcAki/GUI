	...
	<head>
		<link href="../css/criteria.css" rel="stylesheet" type="text/css">
			<link href="../css/sys.css" rel="stylesheet" type="text/css">
				<%@ include file="../common/incHead2.jsp"%>
...
#newsletter_topics label.error {
	...
	<body>
		...
		<s:form id="strutsForm" action="doAddItemsByCondition"
						...
						<td>
							...
							<table width="600" border="0" class="form_tb">
								...
								<tr>
									...
									<td  align="left" >
										<input type="text" value="" name="startLevel" id="startLevel"
											size="5" style="display: none;" /><select name="selectedCompare" id="selectedCompare">
											<option label="不限" value="0">
												不限
											</option>
											<option label="等级 ＞ x" value="&gt;">
												等级 ＞ x
											</option>
											<option label="等级 ≥ x" value="&gt;=">
												等级 ≥ x
											...
											<option label="y ≤ 等级 ≤ x" value="between">
												y ≤ 等级 ≤ x
											</option>
										</select><input type="text" value="" name="endLevel" id="endLevel"
								...
								<tr>
									...
									<td align="left">
										<input type="text" value="" name="lastDays" id="lastDays"
											style="width: 30px;" />
										&nbsp;天之内
									</td>
								</tr>
