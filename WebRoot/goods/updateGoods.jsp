...
<html>
  ...
  <%@ include file="../common/incBanner.jsp" %>
  	<s:form name="strutsForm" action="doUpdate" namespace="/goods" method="post">
    ...
    <caption>增加商品</caption>
  	  <tr>
  	    <td colspan="5"><s:hidden name="goods.isUsed"></s:hidden></td>
      </tr>
      
  	  <tr>
  	    <td align="right">所属类别:</td>
  	    <td align="left"><s:select cssClass="txtW2" name="goods.goodsFlag" list="%{#{0:'===请选择类别===',10:'移动直充 ',11:'电信直充',12:'联通直充',13:'游戏直充',20:'充值卡',30:'广东电信单一缴费',31:'广东电信宽带',32:'广东电信综合缴费'}}"/></td>
  	    <td align="right">&nbsp;</td>
        <td align="left">&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
