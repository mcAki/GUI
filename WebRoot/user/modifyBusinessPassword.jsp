	 ...
	 <div id="comInfo" class="fixed">
          <div id="contain" class="fixed">
              ...
              <div class="tqyj fixed">
                    <strong class="tqxj">修改交易密码</strong>
                    <div class="update fixed">
                             <div class="upadeform">
                    <center><s:fielderror></s:fielderror></center>
                                   <form name="strutsForm" action="/MPRS/usersutils/businessPassword!modifyBusinessPassword.do"  method="post">
                                        <p><label><span>*</span>&nbsp;旧密码：</label><input name="businessPassword" type="password"  class="jmm"/></p>
                                        <p><label><span>*</span>&nbsp;新密码：</label><input name="modifyBusinessPassword.businessPassword" type="password"   class="jmm"/></p>
                                        <p><label><span>*</span>&nbsp;请再次输入密码：</label><input name="retypeNewBusinessPassword" type="password"   class="jmm"/></p>
                                        <p class="anniu">
