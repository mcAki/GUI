  ...
  <head>		<link href="../css/criteria.css" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript">
		...
		function showGroupForLog(){
			...
			//要查询的链接
			var url="${pageContext.request.contextPath}/users/list!listGroupForLog.do?typeId=4";
			//为了处理缓存加入随机时间
  ...
  <%--
    ...
    <caption>商户信息</caption>
  	  ...
  	  <tr>
  	    ...
  	    <td align="left">一级商户<s:hidden name="users.usergroup.id" value="4"/></td>
  	    <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
     ...
     <tr>
  	    ...
  	    <td  align="left"><s:hidden name="users.userType" value="2" />一级经销商</td> 
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
