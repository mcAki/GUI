...
public abstract class BaseCharge implements IChargeable {
...
//	}
	 ...
	 * @throws Exception 
	 */
	public BaseCharge(Integer supplyInterfaceId, Integer supplyId,
	...
	public void run() {
		try {
			...
			if (state == EnumOrderState.OrderApply) {
				this.recharge(orderVO);
			}else if (state == EnumOrderState.ReversalApply) {
				this.reverse(orderVO);
